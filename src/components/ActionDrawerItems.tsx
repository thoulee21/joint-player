...
export const ActionDrawerItems = ({ navigation }: { navigation: any }) => {
  ...
  const renderLogoutIcon = useCallback(
    (props: any) => (
      <Icon {...props} source="logout" color={appTheme.colors.error} />
    ),
  ...
  const logout = useCallback(() => {
    ...
    ToastAndroid.show(t("drawer.account.logout.toast"), ToastAndroid.SHORT);
          ...
          <Portal>
            ...
            >
              ...
              <Dialog.Actions>
                ...
                <Button textColor={appTheme.colors.error} onPress={logout}>
